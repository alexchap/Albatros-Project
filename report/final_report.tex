...
Their definitions can be bound in {\sl damping.h}.
...
The penalty terms of a group of routes are updated every $n$ ticks, where $n$ is the number of
reuse lists, instead of being updated at every tick.
...
This is an important implementation detail : this hash table establishes a link between routes (\textit{i.e.} IP prefix + {\tt\small bgp\_proto})
