...
proto_do_show_stats(struct proto *p)
{
  ...
  cli_msg(-1006, "  Route change stats:     received   rejected   filtered    ignored   accepted     damped");
  cli_msg(-1006, "    Import updates:     %10u %10u %10u %10u %10u %10u",
	  ...
	  s->imp_updates_accepted, s->imp_updates_damped);
...
proto_do_show_pipe_stats(struct proto *p)
{
  ...
  cli_msg(-1006, "    Import updates:     %10u %10u %10u %10u %10u",
	  ...
	  s2->exp_updates_filtered, s2->imp_updates_ignored, s2->imp_updates_accepted, s2->imp_updates_damped);
  cli_msg(-1006, "    Import withdraws:   %10u %10u        --- %10u %10u        ---",
